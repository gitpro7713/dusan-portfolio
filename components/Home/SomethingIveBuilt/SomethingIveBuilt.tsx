        ...
        {/* // TODO : to here  */}
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href={"https://www.pavia.io"} target="_blank" rel="noreferrer">
                <div
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-20 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <a href="https://seacat.rossinavi.it" target={"_blank"} rel="noreferrer">
                <div
                  // onClick={}
                  className="absolute w-full h-full rounded bg-AAprimary 
           transition-opacity opacity-30 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/seacat.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/seacat.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span className="pr-4 z-10">JSS</span>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-10 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/hermitage.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/hermitage.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span className="pr-4 z-10">Kinsta</span>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/shoes.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/shoes.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left">
                <span className="text-AAsecondary">Ena Athletics</span> is Greece&apos;s first premium performance footwear brand, and its website brings that heritage to life through a <span className="text-AAsecondary">seamless, visually rich</span> e-commerce experience.
                The homepage opens with a <span className="text-AAsecondary">captivating video</span> narrative that transitions into layered animations of the <span className="text-AAsecondary">Proto Runner collection</span>, immersing visitors in the “Born of Greece” ethos from the very first moment
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
              ...
              >
                ...
                <span className="pr-4 z-10">Plesk</span>
              </ul>
